...
{
    public partial class InspectorMaidSettings : ScriptableObject, IInspectorMaidSettings
    {
        [field: SerializeField]
        public StyleSheet[] ImportStyleSheets { get; set; } = new StyleSheet[0];

        [field: SerializeField]
        public int MaxNestingDepth { get; set; } = 7;
    }
