...
{
    internal sealed partial class FastReflectionService
    {
    ...
    partial class FastReflectionService
    {
        public static FastReflectionService Of(IWidget widget)
        {
            return widget.GetService<FastReflectionService>();
        }
    }
}
